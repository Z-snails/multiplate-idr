...
%inline
HasProjection ExprPlate Expr where
    project = expr
...
%inline
HasProjection ExprPlate Stmt where
    project = stmt
...
basicMain : IO ()
basicMain = do
    _ <- pure $ doEverything longExample
    putStrLn "Multiplate.Tests.Basic passed"
